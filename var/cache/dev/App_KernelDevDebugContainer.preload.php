...
require __DIR__.'/Container6juB6op/App_KernelDevDebugContainer.php';
require __DIR__.'/Container6juB6op/EntityManager_9a5be93.php';
require __DIR__.'/Container6juB6op/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/Container6juB6op/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/Container6juB6op/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/Container6juB6op/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/Container6juB6op/getValidator_ExpressionService.php';
require __DIR__.'/Container6juB6op/getValidator_EmailService.php';
require __DIR__.'/Container6juB6op/getTwig_Runtime_SerializerService.php';
require __DIR__.'/Container6juB6op/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/Container6juB6op/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/Container6juB6op/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/Container6juB6op/getTwig_Form_RendererService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_YmlService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_XliffService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_ResService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_QtService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_PoService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_PhpService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_MoService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_JsonService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_IniService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_DatService.php';
require __DIR__.'/Container6juB6op/getTranslation_Loader_CsvService.php';
require __DIR__.'/Container6juB6op/getSessionService.php';
require __DIR__.'/Container6juB6op/getServicesResetterService.php';
require __DIR__.'/Container6juB6op/getSerializer_Mapping_CacheClassMetadataFactoryService.php';
require __DIR__.'/Container6juB6op/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/Container6juB6op/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/Container6juB6op/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/Container6juB6op/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/Container6juB6op/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/Container6juB6op/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/Container6juB6op/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/Container6juB6op/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/Container6juB6op/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/Container6juB6op/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/Container6juB6op/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/Container6juB6op/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/Container6juB6op/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/Container6juB6op/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/Container6juB6op/getSecurity_Firewall_Authenticator_MainService.php';
require __DIR__.'/Container6juB6op/getSecurity_ChannelListenerService.php';
require __DIR__.'/Container6juB6op/getSecurity_AccessListenerService.php';
require __DIR__.'/Container6juB6op/getSecrets_VaultService.php';
require __DIR__.'/Container6juB6op/getRouting_LoaderService.php';
require __DIR__.'/Container6juB6op/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/Container6juB6op/getPropertyAccessorService.php';
require __DIR__.'/Container6juB6op/getMimeTypesService.php';
require __DIR__.'/Container6juB6op/getFragment_Renderer_InlineService.php';
require __DIR__.'/Container6juB6op/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/Container6juB6op/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/Container6juB6op/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/Container6juB6op/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/Container6juB6op/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/Container6juB6op/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/Container6juB6op/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/Container6juB6op/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/Container6juB6op/getForm_Type_FormService.php';
require __DIR__.'/Container6juB6op/getForm_Type_EntityService.php';
require __DIR__.'/Container6juB6op/getForm_Type_ColorService.php';
require __DIR__.'/Container6juB6op/getForm_Type_ChoiceService.php';
require __DIR__.'/Container6juB6op/getForm_ServerParamsService.php';
require __DIR__.'/Container6juB6op/getForm_RegistryService.php';
require __DIR__.'/Container6juB6op/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/Container6juB6op/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/Container6juB6op/getErrorControllerService.php';
require __DIR__.'/Container6juB6op/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/Container6juB6op/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/Container6juB6op/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/Container6juB6op/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/Container6juB6op/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/Container6juB6op/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/Container6juB6op/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/Container6juB6op/getDoctrine_Migrations_ContainerAwareMigrationsFactoryService.php';
require __DIR__.'/Container6juB6op/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/Container6juB6op/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/Container6juB6op/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/Container6juB6op/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/Container6juB6op/getSecurityVoterService.php';
require __DIR__.'/Container6juB6op/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/Container6juB6op/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/Container6juB6op/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/Container6juB6op/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/Container6juB6op/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/Container6juB6op/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/Container6juB6op/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/Container6juB6op/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/Container6juB6op/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/Container6juB6op/getBatchActionDtoResolverService.php';
require __DIR__.'/Container6juB6op/getAdminContextResolverService.php';
require __DIR__.'/Container6juB6op/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/Container6juB6op/getContainer_GetenvService.php';
require __DIR__.'/Container6juB6op/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/Container6juB6op/getContainer_EnvVarProcessorService.php';
require __DIR__.'/Container6juB6op/getCache_SystemClearerService.php';
require __DIR__.'/Container6juB6op/getCache_GlobalClearerService.php';
require __DIR__.'/Container6juB6op/getCache_AppClearerService.php';
require __DIR__.'/Container6juB6op/getTemplateControllerService.php';
require __DIR__.'/Container6juB6op/getRedirectControllerService.php';
require __DIR__.'/Container6juB6op/getFieldProviderService.php';
require __DIR__.'/Container6juB6op/getEntityUpdaterService.php';
require __DIR__.'/Container6juB6op/getEntityRepositoryService.php';
require __DIR__.'/Container6juB6op/getFiltersFormTypeService.php';
require __DIR__.'/Container6juB6op/getFileUploadTypeService.php';
require __DIR__.'/Container6juB6op/getCrudFormTypeService.php';
require __DIR__.'/Container6juB6op/getEaCrudFormTypeExtensionService.php';
require __DIR__.'/Container6juB6op/getSlugConfiguratorService.php';
require __DIR__.'/Container6juB6op/getNumberConfiguratorService.php';
require __DIR__.'/Container6juB6op/getMoneyConfiguratorService.php';
require __DIR__.'/Container6juB6op/getDateTimeConfiguratorService.php';
require __DIR__.'/Container6juB6op/getCountryConfiguratorService.php';
require __DIR__.'/Container6juB6op/getCommonPreConfiguratorService.php';
require __DIR__.'/Container6juB6op/getCommonPostConfiguratorService.php';
require __DIR__.'/Container6juB6op/getChoiceConfiguratorService.php';
require __DIR__.'/Container6juB6op/getBooleanConfiguratorService.php';
require __DIR__.'/Container6juB6op/getAssociationConfiguratorService.php';
require __DIR__.'/Container6juB6op/getPaginatorFactoryService.php';
require __DIR__.'/Container6juB6op/getFormFactoryService.php';
require __DIR__.'/Container6juB6op/getFilterFactoryService.php';
require __DIR__.'/Container6juB6op/getExceptionListenerService.php';
require __DIR__.'/Container6juB6op/getCrudResponseListenerService.php';
require __DIR__.'/Container6juB6op/getTypeRepositoryService.php';
require __DIR__.'/Container6juB6op/getTrekkingRepositoryService.php';
require __DIR__.'/Container6juB6op/getTownRepositoryService.php';
require __DIR__.'/Container6juB6op/getStartRepositoryService.php';
require __DIR__.'/Container6juB6op/getDistrictRepositoryService.php';
require __DIR__.'/Container6juB6op/getDifficultyRepositoryService.php';
require __DIR__.'/Container6juB6op/getCrossingPointsRepositoryService.php';
require __DIR__.'/Container6juB6op/getAdminRepositoryService.php';
require __DIR__.'/Container6juB6op/getRegisterTypeService.php';
require __DIR__.'/Container6juB6op/getRegisterControllerService.php';
require __DIR__.'/Container6juB6op/getHomeControllerService.php';
require __DIR__.'/Container6juB6op/getTypeCrudControllerService.php';
require __DIR__.'/Container6juB6op/getTrekkingCrudControllerService.php';
require __DIR__.'/Container6juB6op/getTownCrudControllerService.php';
require __DIR__.'/Container6juB6op/getStartCrudControllerService.php';
require __DIR__.'/Container6juB6op/getDistrictCrudControllerService.php';
require __DIR__.'/Container6juB6op/getDifficultyCrudControllerService.php';
require __DIR__.'/Container6juB6op/getDashboardControllerService.php';
require __DIR__.'/Container6juB6op/getCrossingPointsCrudControllerService.php';
require __DIR__.'/Container6juB6op/getAdminCrudControllerService.php';
require __DIR__.'/Container6juB6op/get_Session_DeprecatedService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_Tbo4JjvService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_SYnOCh8Service.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_RAlqQ78Service.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_Q6hAO0Service.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_OpmhHvService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_L2QwsaZService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_ZOQ9v2dService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_W9y3dzmService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_U4BbnsnService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_SxWgT3IService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_Nt_OgDbService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_CKlWSjaService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_AWPr3oyService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_4C0Bh8jService.php';
require __DIR__.'/Container6juB6op/get_ServiceLocator_2dc0eaXService.php';
require __DIR__.'/Container6juB6op/get_Container_Private_SerializerService.php';
require __DIR__.'/Container6juB6op/get_Container_Private_Form_Type_FileService.php';
require __DIR__.'/Container6juB6op/get_Container_Private_Form_FactoryService.php';
require __DIR__.'/Container6juB6op/get_Container_Private_FilesystemService.php';
require __DIR__.'/Container6juB6op/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Controller\Admin\CrossingPointsCrudController';
$classes[] = 'App\Controller\Admin\DashboardController';
$classes[] = 'App\Controller\Admin\DifficultyCrudController';
$classes[] = 'App\Controller\Admin\DistrictCrudController';
$classes[] = 'App\Controller\Admin\StartCrudController';
$classes[] = 'App\Controller\Admin\TownCrudController';
$classes[] = 'App\Controller\Admin\TrekkingCrudController';
...
$classes[] = 'App\Repository\CrossingPointsRepository';
$classes[] = 'App\Repository\DifficultyRepository';
$classes[] = 'App\Repository\DistrictRepository';
$classes[] = 'App\Repository\StartRepository';
$classes[] = 'App\Repository\TownRepository';
$classes[] = 'App\Repository\TrekkingRepository';
