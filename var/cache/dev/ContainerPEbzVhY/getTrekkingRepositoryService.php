 ...
 */
class getTrekkingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrekkingRepository' shared autowired service.
     *
     * @return \App\Repository\TrekkingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrekkingRepository.php';

        return $container->privates['App\\Repository\\TrekkingRepository'] = new \App\Repository\TrekkingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
