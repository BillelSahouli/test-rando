 ...
 */
class getCrossingPointsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CrossingPointsRepository' shared autowired service.
     *
     * @return \App\Repository\CrossingPointsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CrossingPointsRepository.php';

        return $container->privates['App\\Repository\\CrossingPointsRepository'] = new \App\Repository\CrossingPointsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
