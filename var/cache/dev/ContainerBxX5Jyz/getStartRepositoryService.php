 ...
 */
class getStartRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StartRepository' shared autowired service.
     *
     * @return \App\Repository\StartRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StartRepository.php';

        return $container->privates['App\\Repository\\StartRepository'] = new \App\Repository\StartRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
